(function() {
  looker.plugins.visualizations.add( {
    ...
    update: function(data, element, settings, resp) {
      ...
      var equalWidth = settings.equalWidth || true;
      ...
      .html(function(d) {
        if (d.type == 'measure' && d.data.rendered !== '') {
          ...
          if (d.data.rendered || '' !== ''){
           outputHtml = outputHtml.concat('<span style="color:#000000;">');
         ...
         if (d.data2.rendered || '' !== ''){
           ...
           outputHtml = outputHtml.concat('<span style="width:100%;display:block;color:#000000;">');
              ...
              return '<span style="color:#000000;text-align:right">'+(d.data.rendered ||d.data.value || '')
            }
          })
      .on('click', function(d) {
