  ...
  looker.plugins.visualizations.add({
    ...
    options: {
      ...
      colorPreSet:
      {
        ...
        {'Green, Yellow, Red': '#00FF00,#FFFF00,#FF0000'},
    ...
    .style('white-space', function(d) {
      ...
      .html(function(d) {
        if (d.type == 'measure' && d.data.rendered !== '') {
          ...
          if (d.data.rendered || '' !== ''){
           outputHtml = outputHtml.concat('<span style="color:#000000;font-weight:900;">');
           outputHtml = outputHtml.concat(d.data.rendered ||d.data.rendered || '' );
           outputHtml = outputHtml.concat('</span>');
           addBreak = 1
         };
         if (d.data1.rendered || '' !== ''){
           outputHtml = outputHtml.concat('<span style="color:#000000;font-weight:300;">');
           if(addBreak = 1){
         ...
         if (d.data2.rendered || '' !== ''){
           ...
           outputHtml = outputHtml.concat('<span style="width:100%;display:block;color:#000000;font-weight:300;">');
